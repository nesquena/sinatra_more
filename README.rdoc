...
The extreme simplicity of the framework is quite refreshing. I have been using Sinatra increasingly
more for recent projects. First for small and simple json and xml web services and then even
for more complex full-featured applications. This gem represents my attempt to make it as fun and easy
as possible to code web more advanced view-heavy web applications in Sinatra.
