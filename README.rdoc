...
I am working on (with Lipsiasoft and others) called the {Padrino Framework}[http://github.com/padrino/padrino-framework]. 
...
and follow that philosophy but to super-charge the baked in functionality including support for
automatic code reloading, far more advanced route definitions, baked-in orm support, baked-in code generators, et al.
