...
* Page, fragment and model caching akin to the caching support in rails (with a Sinatra twist)
...
See the wiki article for additional information: <http://wiki.github.com/nesquena/sinatra_more/cachingplugin>
